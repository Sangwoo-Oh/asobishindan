...
export declare function reverseAnimationResolver(animation: AnimationReferenceMetadata): AnimationReferenceMetadata;
export declare function isHorizontalAnimation(animation: AnimationReferenceMetadata): boolean;
export declare function isVerticalAnimation(animation: AnimationReferenceMetadata): boolean;
